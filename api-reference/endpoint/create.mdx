...
<ParamField body="phone" type="string">
  Este é o parametro para telefone e deve iniciar com 55.
</ParamField>

<ParamField body="nome" type="string">
  Este é o parametro para o nome do customer.
</ParamField>

<ParamField body="email" type="string">
  Este é o parametro e-mail do customer.
</ParamField>

<ParamField body="taxId" type="string">
  Este é o parametro para CPF ou CNPJ.
</ParamField>

<ParamField body="metadata" type="object">
  Este é o parametro é um campo livre para inserção de dados.
</ParamField>
